...
def load_model(
    ...
    xml_string = get_model_xml(robot, scene_xml, wooden_skin=wooden_skin)
...
def get_model_xml(robot: str, scene_xml: str, wooden_skin: bool = True) -> str:
    ...
    wood_enabled = wooden_skin and robot == "unitree_go1"
