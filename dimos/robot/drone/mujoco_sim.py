...
from dimos.robot.drone.mujoco_drone import (
    GPS_ORIGIN_LAT,
    GPS_ORIGIN_LON,
    EARTH_R,
    MuJocoDroneController,
    _find_skydio_model,
    _local_to_gps,
)
...
class DimOSBridge:
    ...
    def __init__(self, controller: MuJocoDroneController) -> None:
    ...
    def _start_agent(self) -> None:
        try:
            ...
            from dimos.robot.drone.drone import DRONE_SYSTEM_PROMPT
...
def main() -> None:
    scene_path = _find_skydio_model(city=True)
    ...
    controller = MuJocoDroneController(model, data)
