...
all_blueprints = {
    ...
    "teleop-quest-go2-moves": "dimos.teleop.quest.go2_moves:teleop_quest_go2_moves",
    ...
    "unitree-go2-agentic-lite": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_agentic_lite:unitree_go2_agentic_lite",
    ...
    "unitree-go2-gesture-lite": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_gesture_lite:unitree_go2_gesture_lite",
    "unitree-go2-keyfinder": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_keyfinder:unitree_go2_keyfinder",
    "unitree-go2-keyfinder-explore": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_keyfinder_explore:unitree_go2_keyfinder_explore",
    "unitree-go2-keyfinder-view": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_keyfinder_view:unitree_go2_keyfinder_view",
    ...
    "unitree-go2-keyboard-view": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_keyboard_view:unitree_go2_keyboard_view",
    ...
    "unitree-go2-narrate": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_narrate:unitree_go2_narrate",
...
all_modules = {
    ...
    "scene-narrator": "dimos.agents.scene_narrator.SceneNarrator",
